...
void InitOpcodes()
{
	...
	DEFINE_OPCODE_HANDLER(CMSG_ACCEPT_WARGAME_INVITE,					STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::Handle_NULL					   );
	...
	DEFINE_OPCODE_HANDLER(CMSG_ADD_BATTLENET_FRIEND,					STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::Handle_NULL					   );
	...
	//DEFINE_OPCODE_HANDLER(CMSG_ARENA_TEAM_ACCEPT, STATUS_UNHANDLED PROCESS_THREADUNSAFE, &WorldSession::Handle_NULL);
	DEFINE_OPCODE_HANDLER(CMSG_ARENA_TEAM_CREATE,						STATUS_UNHANDLED, PROCESS_THREADUNSAFE, &WorldSession::Handle_NULL						);
	DEFINE_OPCODE_HANDLER(CMSG_ARENA_TEAM_DECLINE,						STATUS_UNHANDLED, PROCESS_THREADUNSAFE, &WorldSession::Handle_NULL						);
	DEFINE_OPCODE_HANDLER(CMSG_ARENA_TEAM_DISBAND,						STATUS_UNHANDLED, PROCESS_THREADUNSAFE, &WorldSession::Handle_NULL						);
	DEFINE_OPCODE_HANDLER(CMSG_ARENA_TEAM_INVITE,						STATUS_UNHANDLED, PROCESS_THREADUNSAFE, &WorldSession::Handle_NULL						);
	DEFINE_OPCODE_HANDLER(CMSG_ARENA_TEAM_LEADER,						STATUS_UNHANDLED, PROCESS_THREADUNSAFE, &WorldSession::Handle_NULL						);
	DEFINE_OPCODE_HANDLER(CMSG_ARENA_TEAM_QUERY,						STATUS_UNHANDLED, PROCESS_THREADUNSAFE, &WorldSession::Handle_NULL						);
	DEFINE_OPCODE_HANDLER(CMSG_ARENA_TEAM_REMOVE,						STATUS_UNHANDLED, PROCESS_THREADUNSAFE, &WorldSession::Handle_NULL						);
	DEFINE_OPCODE_HANDLER(CMSG_ARENA_TEAM_ROSTER,						STATUS_UNHANDLED, PROCESS_THREADUNSAFE, &WorldSession::Handle_NULL						);
	...
	DEFINE_OPCODE_HANDLER(CMSG_AUTH_SRP6_RECODE,						STATUS_UNHANDLED, PROCESS_THREADUNSAFE, &WorldSession::Handle_NULL					   );
	...
	DEFINE_OPCODE_HANDLER(CMSG_AUTEQUIP_GROUND_ITEM,					STATUS_UNHANDLED, PROCESS_THREADUNSAFE, &WorldSession::Handle_NULL					   );
	...
	DEFINE_OPCODE_HANDLER(CMSG_AUTOSTORE_BANK_REAGENT,					STATUS_UNHANDLED, PROCESS_THREADUNSAFE, &WorldSession::Handle_NULL					   );
	...
	DEFINE_OPCODE_HANDLER(CMSG_BATTLE_PAY_ACK_FAILED_RESPONSE,			STATUS_UNHANDLED, PROCESS_THREADUNSAFE, &WorldSession::Handle_NULL					   );
	DEFINE_OPCODE_HANDLER(CMSG_BATTLE_PAY_CONFIRM_PURCHASE_RESPONSE,	STATUS_UNHANDLED, PROCESS_THREADUNSAFE, &WorldSession::Handle_NULL					   );
	DEFINE_OPCODE_HANDLER(CMSG_BATTLE_PAY_DISTRIBUTION_ASSIGN_TO_TARGET, STATUS_UNHANDLED, PROCESS_THREADUNSAFE, &WorldSession::Handle_NULL					   );
	DEFINE_OPCODE_HANDLER(CMSG_BATTLE_PAY_GET_PRODUCT_LIST,				STATUS_UNHANDLED, PROCESS_THREADUNSAFE, &WorldSession::Handle_NULL					   );
	DEFINE_OPCODE_HANDLER(CMSG_BATTLE_PAY_GET_PURCHASE_LIST,			STATUS_UNHANDLED, PROCESS_THREADUNSAFE, &WorldSession::Handle_NULL					   );
	DEFINE_OPCODE_HANDLER(CMSG_BATTLE_PAY_START_PURCHASE,				STATUS_UNHANDLED, PROCESS_THREADUNSAFE, &WorldSession::Handle_NULL					   );
	DEFINE_OPCODE_HANDLER(CMSG_BATTLE_PAY_START_VAS_PURCHASE,			STATUS_UNHANDLED, PROCESS_THREADUNSAFE, &WorldSession::Handle_NULL					   );
	DEFINE_OPCODE_HANDLER(CMSG_BATTLE_PET_DELETE_PET,					STATUS_UNHANDLED, PROCESS_THREADUNSAFE, &WorldSession::Handle_NULL					   );
	DEFINE_OPCODE_HANDLER(CMSG_BATTLE_PET_DELETE_PET_CHEAT,				STATUS_UNHANDLED, PROCESS_THREADUNSAFE, &WorldSession::Handle_NULL						);
	DEFINE_OPCODE_HANDLER(CMSG_BATTLE_PET_FINAL_NOTIFY,					STATUS_UNHANDLED, PROCESS_THREADUNSAFE, &WorldSession::Handle_NULL						);
	DEFINE_OPCODE_HANDLER(CMSG_BATTLE_PET_INITIAL_UPDATE_RESPONSE,		STATUS_UNHANDLED, PROCESS_THREADUNSAFE, &WorldSession::Handle_NULL						);
	DEFINE_OPCODE_HANDLER(CMSG_BATTLE_PET_MODIFY_NAME,					STATUS_UNHANDLED, PROCESS_THREADUNSAFE, &WorldSession::Handle_NULL						);
	DEFINE_OPCODE_HANDLER(CMSG_BATTLE_PET_QUERY_NAME,					STATUS_UNHANDLED, PROCESS_THREADUNSAFE, &WorldSession::Handle_NULL						);
	DEFINE_OPCODE_HANDLER(CMSG_BATTLE_PET_REQUEST_JOURNAL,				STATUS_UNHANDLED, PROCESS_THREADUNSAFE, &WorldSession::Handle_NULL						);
	DEFINE_OPCODE_HANDLER(CMSG_BATTLE_PET_ROUND,						STATUS_UNHANDLED, PROCESS_THREADUNSAFE, &WorldSession::Handle_NULL						);
	DEFINE_OPCODE_HANDLER(CMSG_BATTLE_PET_SET_BATTLE_SLOT,				STATUS_UNHANDLED, PROCESS_THREADUNSAFE, &WorldSession::Handle_NULL						);
	DEFINE_OPCODE_HANDLER(CMSG_BATTLE_PET_SET_FLAGS,					STATUS_UNHANDLED, PROCESS_THREADUNSAFE, &WorldSession::Handle_NULL						);
	DEFINE_OPCODE_HANDLER(CMSG_BATTLE_PET_SUMMON_COMPANION,				STATUS_UNHANDLED, PROCESS_THREADUNSAFE, &WorldSession::Handle_NULL						);
	DEFINE_OPCODE_HANDLER(CMSG_BATTLE_PET_UPDATE_NOTIFY,				STATUS_UNHANDLED, PROCESS_THREADUNSAFE, &WorldSession::Handle_NULL						);
    //DEFINE_OPCODE_HANDLER(CMSG_BATTLEPET_NAME_QUERY,                    STATUS_UNHANDLED, PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
	...
	DEFINE_OPCODE_HANDLER(CMSG_CHEAT_DUMP_ITEMS_DEBUG_ONLY,				STATUS_UNHANDLED, PROCESS_THREADUNSAFE, &WorldSession::Handle_NULL					   );
	DEFINE_OPCODE_HANDLER(CMSG_CHEAT_PLAYER_LOGIN,						STATUS_UNHANDLED, PROCESS_THREADUNSAFE, &WorldSession::Handle_NULL					   );
	DEFINE_OPCODE_HANDLER(CMSG_CHEAT_PLAYER_LOOKUP,						STATUS_UNHANDLED, PROCESS_THREADUNSAFE, &WorldSession::Handle_NULL					   );
	DEFINE_OPCODE_HANDLER(CMSG_CHEAT_RESETFACTION,						STATUS_UNHANDLED, PROCESS_THREADUNSAFE, &WorldSession::Handle_NULL						);
	DEFINE_OPCODE_HANDLER(CMSG_CHEAT_SETMONEY,							STATUS_UNHANDLED, PROCESS_THREADUNSAFE, &WorldSession::Handle_NULL						);
	DEFINE_OPCODE_HANDLER(CMSG_CHEAT_SET_ARENA_CURRENCY,				STATUS_UNHANDLED, PROCESS_THREADUNSAFE, &WorldSession::Handle_NULL						);
	DEFINE_OPCODE_HANDLER(CMSG_CHEAT_SET_HONOR_CURRENCY,				STATUS_UNHANDLED, PROCESS_THREADUNSAFE, &WorldSession::Handle_NULL						);
	DEFINE_OPCODE_HANDLER(CMSG_CHECK_LOGIN_CRITERIA,					STATUS_AUTHED, PROCESS_THREADUNSAFE, &WorldSession::Handle_EarlyProccess				);
	...
	DEFINE_OPCODE_HANDLER(CMSG_CHALLANGES_INFO,							STATUS_UNHANDLED, PROCESS_THREADUNSAFE, &WorldSession::Handle_NULL						);
	DEFINE_OPCODE_HANDLER(CMSG_CHALLANGE_MODE_REQUEST_LEADERS,			STATUS_UNHANDLED, PROCESS_THREADUNSAFE, &WorldSession::Handle_NULL						);
	DEFINE_OPCODE_HANDLER(CMSG_CHALLANGE_MODE_REQUEST_MAP_STATS,		STATUS_UNHANDLED, PROCESS_THREADUNSAFE, &WorldSession::Handle_NULL						);
	DEFINE_OPCODE_HANDLER(CMSG_CHALLANGE_MODE_REWARDS,					STATUS_UNHANDLED, PROCESS_THREADUNSAFE, &WorldSession::Handle_NULL						);
    ...
    //DEFINE_OPCODE_HANDLER(SMSG_BATTLEPET_JOURNAL_LOCK_ACQUIRED,         STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide               );
    //DEFINE_OPCODE_HANDLER(SMSG_BATTLEPET_JOURNAL_LOCK_DENIED,           STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide               );
    ...
    //DEFINE_OPCODE_HANDLER(SMSG_BATTLE_PET_FULL_UPDATE,                  STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide               );
    //DEFINE_OPCODE_HANDLER(SMSG_BATTLE_PET_FINAL_ROUND,                  STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide               );
    //DEFINE_OPCODE_HANDLER(SMSG_BATTLE_PET_FINISHED,                     STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide               );
    //DEFINE_OPCODE_HANDLER(SMSG_BATTLE_PET_FIRST_ROUND,                  STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide               );
    //DEFINE_OPCODE_HANDLER(SMSG_BATTLE_PET_MAX_GAME_LENGHT_WARNING,      STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide               );
    //DEFINE_OPCODE_HANDLER(SMSG_BATTLE_PET_PVP_CHALLENGE,                STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide               );
    ...
    //DEFINE_OPCODE_HANDLER(SMSG_BATTLE_PET_REPLACEMENTS_MADE,            STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide               );
    ...
    DEFINE_OPCODE_HANDLER(SMSG_CHAR_CREATE,                             STATUS_AUTHED,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide               );
    DEFINE_OPCODE_HANDLER(SMSG_CHAR_CUSTOMIZE,                          STATUS_AUTHED,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide               );
    DEFINE_OPCODE_HANDLER(SMSG_CHAR_DELETE,                             STATUS_AUTHED,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide               );
    DEFINE_OPCODE_HANDLER(SMSG_CHAR_ENUM,                               STATUS_AUTHED,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide               );
