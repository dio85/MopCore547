...
enum Opcodes
{
	...
	CMSG_ACCEPT_WARGAME_INVITE						  =	0x0179,	// 5.4.8 18414
	CMSG_ACTIVATETAXI								  = 0x03C9,	// 5.4.8 18414
    CMSG_ACTIVATETAXIEXPRESS                          = 0x06FB, // 5.4.8 18414
	CMSG_ADDON_LIST									  = 0x0000,
	...
	CMSG_ADD_BATTLENET_FRIEND						  = 0x09A6,	// 5.4.8 18414
    CMSG_ALTER_APPEARANCE                             = 0x07F0, // 5.4.8 18414
    CMSG_AREATRIGGER                                  = 0x1C44, // 5.4.8 18414
    CMSG_AREA_SPIRIT_HEALER_QUERY                     = 0x03F1, // 5.4.8 18414
    ...
    CMSG_ATTACKSWING                                  = 0x02E4, // 5.4.8 18414
    CMSG_AUCTION_HELLO                                = 0x0379, // 5.4.8 18414
    ...
    CMSG_AUCTION_LIST_PENDING_SALES                   = 0x02DA, // 5.4.8 18414
    ...
    CMSG_BATTLEFIELD_JOIN                             = 0x178A, // 5.4.8 18414
	...
	CMSG_BATTLE_PAY_ACK_FAILED_RESPONSE				  = 0x0B38,	// 5.4.8 18414
	...
	CMSG_BATTLE_PET_FINAL_NOTIFY					  = 0x1063,	// 5.4.8 18414
	CMSG_BATTLE_PET_INITIAL_UPDATE_RESPONSE			  = 0x1A07,	// 5.4.8 18414
	CMSG_BATTLE_PET_UPDATE_NOTIFY					  = 0x0675,	// 5.4.8 18414
	...
	CMSG_BATTLE_PET_REQUEST_JOURNAL					  = 0x0A23,	// 5.4.8 18414
	CMSG_BATTLE_PET_ROUND							  = 0x0000,
	CMSG_BATTLENET_CHALLENGE_RESPONSE				  =	0x17AA,	// 5.4.8 18414
    CMSG_BEGIN_TRADE                                  = 0x1CE3, // 5.4.8 18414
    CMSG_BINDER_ACTIVATE                              = 0x1248, // 5.4.8 18414
    CMSG_BLACK_MARKET_HELLO                           = 0x075A, // 5.4.8 18414
    CMSG_BLACK_MARKET_REQUEST_ITEMS                   = 0x127A, // 5.4.8 18414
    CMSG_BLACK_MARKET_PLACE_BID                       = 0x12C8, // 5.4.8 18414
    CMSG_BUG                                          = 0x09E1, // 5.4.8 18414
    CMSG_BUSY_TRADE                                   = 0x0276,	// 5.4.8 18414
    CMSG_BUYBACK_ITEM                                 = 0x0661, // 5.4.8 18414
    CMSG_BUY_BANK_SLOT                                = 0x12F2, // 5.4.8 18414
    CMSG_BUY_ITEM                                     = 0x02E2, // 5.4.8 18414
	CMSG_BUY_LOTTERY_TICKET_OBSOLOTE				  = 0x0000,	// 5.4.8 18414 NEED
	CMSG_BUY_STABLE_SLOT							  = 0x0000,	// 5.4.8 18414 NEED
	CMSG_CAGE_BATTLE_PET							  = 0x1561,	// 5.4.8 18414
    CMSG_CALENDAR_ADD_EVENT                           = 0x0A37, // 5.4.8 18414
    CMSG_CALENDAR_ARENA_TEAM                          = 0x0000,	// 5.4.8 18414
    ...
    CMSG_CALENDAR_GET_NUM_PENDING                     = 0x0813, // 5.4.8 18414
	...
	CMSG_CANCEL_GROWTH_AURA							  = 0x02D6,	// 5.4.8 18414
    CMSG_CANCEL_MOUNT_AURA                            = 0x10E3, // 5.4.8 18414
    CMSG_CANCEL_QUEUED_SPELL                          = 0x1207,	// 5.4.8 18414
	...
	CMSG_CHEAT_RESETFACTION							  =	0x10B6,
	...
	CMSG_CHALLANGES_INFO							  =	0x1452,
	CMSG_CHALLANGE_MODE_REQUEST_LEADERS				  =	0x15DB,
	CMSG_CHALLANGE_MODE_REQUEST_MAP_STATS			  =	0x1C5A,
	CMSG_CHALLANGE_MODE_REWARDS					   	  =	0x0000,
    CMSG_CHANGE_SEATS_ON_CONTROLLED_VEHICLE           = 0x053B, // 5.4.7 18019
	CMSG_CHANGE_GDF_ARENA_RATING					  =	0x0000,
	CMSG_CHANGE_PERSONALE_ARENA_RATING				  =	0x0000,
    CMSG_CHANNEL_ANNOUNCEMENTS                        = 0x06AF, // 5.4.8 18414
    CMSG_CHANNEL_BAN                                  = 0x08BF, // 5.4.8 18414
    CMSG_CHANNEL_INVITE                               = 0x10AB, // 5.4.8 18414
    CMSG_CHANNEL_KICK                                 = 0x0E0B, // 5.4.8 18414
    CMSG_CHANNEL_LIST                                 = 0x160F, // 5.4.8 18414
    CMSG_CHANNEL_MODERATOR                            = 0x00AE, // 5.4.8 18414
    CMSG_CHANNEL_MUTE                                 = 0x000A, // 5.4.8 18414
    CMSG_CHANNEL_PASSWORD                             = 0x0A1E, // 5.4.8 18414
    CMSG_CHANNEL_SET_OWNER                            = 0x141A, // 5.4.8 18414
    CMSG_CHANNEL_SILENCE_ALL                          = 0x0E0E,	// 5.4.8 18414
    CMSG_CHANNEL_SILENCE_VOICE                        = 0x140A,	// 5.4.8 18414
    CMSG_CHANNEL_UNBAN                                = 0x081F, // 5.4.8 18414
    CMSG_CHANNEL_UNMODERATOR                          = 0x041E, // 5.4.8 18414
    CMSG_CHANNEL_UNMUTE                               = 0x022A, // 5.4.8 18414
    CMSG_CHANNEL_UNSILENCE_ALL                        = 0x10BB,	// 5.4.8 18414
    CMSG_CHANNEL_UNSILENCE_VOICE                      = 0x0ABA,	// 5.4.8 18414
    CMSG_CHANNEL_VOICE_OFF                            = 0x10AE,	// 5.4.8 18414
    CMSG_CHANNEL_VOICE_ON                             = 0x129B,	// 5.4.8 18414
    ...
    CMSG_CLEAR_CHANNEL_WATCH                          = 0x13F4,	// 5.4.8 18414
    ...
    CMSG_COMPLAIN                                     = 0x0319, // 5.4.8 18414
    CMSG_COMPLETE_CINEMATIC                           = 0x1F34, // 5.4.8 18414
    CMSG_COMPLETE_MOVIE                               = 0x1362, // 5.4.8 18414
    CMSG_CONNECT_TO_FAILED                            = 0x10B6, // 5.4.8 18414
	...
	CMSG_DB_QUERY_BULK								  =	0x158D,	// 5.4.8 18414
    ...
    CMSG_MOVE_FORCE_RUN_BACK_SPEED_CHANGE_ACK         = 0x0158, // 5.4.8 18414
    CMSG_MOVE_FORCE_SWIM_BACK_SPEED_CHANGE_ACK        = 0x10D1, // 5.4.8 18414
    CMSG_MOVE_FORCE_FLIGHT_BACK_SPEED_CHANGE_ACK      = 0x105B, // 5.4.8 18414
    ...
    CMSG_NEXT_CINEMATIC_CAMERA                        = 0x1124, // 5.4.8 18414
	CMSG_NPC_TEXT_QUERY								  =	0x0287,	// 5.4.8 18414
    CMSG_OBJECT_UPDATE_FAILED                         = 0x1061, // 5.4.8 18414
    CMSG_OBJECT_UPDATE_RESCUED                        = 0x19E3, // 5.4.8 18414
    ...
    CMSG_PLAYER_VEHICLE_ENTER                         = 0x0277, // 5.4.8 18414
    ...
    CMSG_QUERY_GUILD_REWARDS                          = 0x06C4, // 5.4.8 18414
    CMSG_QUERY_GUILD_XP                               = 0x05F8, // 5.4.8 18414
    ...
    CMSG_REALM_SPLIT                                  = 0x18B2, // 5.4.8 18414
    ...
    SMSG_ACCOUNT_CRITERIA_UPDATE                      = 0x189E, // 5.4.8 18414
    ...
    SMSG_CHARACTER_LOGIN_FAILED                       = 0x1A0B,	// 5.4.8 18414
    ...
    SMSG_CLIENT_CACHE_VERSION                         = 0x002A, // 5.4.8 18414
    ...
    SMSG_REALM_QUERY_RESPONSE                         = 0x1A16, // 5.4.8 18414
    SMSG_REALM_SPLIT                                  = 0x1A2E, // 5.4.8 18414
    SMSG_REAL_GROUP_UPDATE                            = 0x0000,
    SMSG_RECEIVED_MAIL                                = 0x116E, // 0x0D60, // 5.4.7 18019 - CHECK!
    SMSG_REDIRECT_CLIENT                              = 0x1149, // 5.4.8 18414
    ...
    SMSG_SERVER_INFO_RESPONSE                         = 0x022E,	// 5.4.8 18414
    ...
    SMSG_XP_GAIN_ABORTED                              = 0x1A2B, // 5.4.8 18414
